Create Database competition_system_security_concept_v2_db CHARACTER SET latin1 COLLATE latin1_general_ci;
...
insert role (role_name) values ('assist');
...
GRANT SELECT ON file TO 'assist'@'%';
GRANT SELECT, UPDATE, INSERT ON user TO 'assist'@'%';
